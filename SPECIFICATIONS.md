...
カードハンターは、プレイヤーが順番に他のプレイヤーのカードを予想していくカードゲームです。
...
2. 予想時のルール
   - 予想が当たった場合：
     ...
     - 続けて次の予想ができます
   - 予想が外れた場合：
     - 自分のカードを1枚表向きにしなければなりません
     - 次のプレイヤーの番になります

3. ゲーム終了条件
   - いずれかのプレイヤーの全カードが表向きになった時点でそのプレイヤーは脱落
...
3. **プレイヤーの脱落判定**
   - 全てのカードが表になった時点で脱落
   - 脱落のタイミング：
     - 予想される側として最後のカードを当てられた時
     - 予想する側として予想を外し、自分の最後のカードを表にした時
   - 脱落順に基づく順位付け：
     - 最初に脱落 → 4位
     - 2番目に脱落 → 3位
     - 3番目に脱落 → 2位
